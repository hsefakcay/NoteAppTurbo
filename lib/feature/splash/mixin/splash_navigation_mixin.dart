...
mixin SplashNavigationMixin<T extends StatefulWidget> on State<T> {
  ...
  /// Auth kontrolü yapar ve uygun ekrana yönlendirir
  Future<void> checkAuthAndNavigate() async {
    await Future.microtask(() async {
      ...
      // Navigasyon işlemi
      if (!mounted) return;
      _navigateToNextScreen(authCubit.state.isAuthenticated);
    });
  }

  /// Kullanıcının auth durumuna göre uygun ekrana yönlendirir
